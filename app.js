...
function getTasaBase(){
  ...
  const manual=parseFloat(document.getElementById('rl-t').value);
  if(manual>0) return manual;
  if(LEC.length>0) return LEC[0].tna; // fallback a primera LECAP activa
  return 35;
}
